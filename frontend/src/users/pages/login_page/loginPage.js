...
function LoginPage({changeNavbarToAdmin,changeNavbarToUser}) {
    return (
    <>
        <div className="main-login-page-container">
            ...
            <div className="login-container">
                ...
                <div className="user-identiy-button-container">
                    <Link to="/user/home"><Button identity="User" status="selected" changeNavbar={changeNavbarToUser}/></Link>
                    <Link to="/admin/order"><Button identity="Admin" status="not-selected" changeNavbar={changeNavbarToAdmin}/></Link>
                </div>
